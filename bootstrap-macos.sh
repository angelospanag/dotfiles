...
brew install exiftool git gnupg nmap podman pwgen

# GUI apps
brew install --cask adguard font-fira-code-nerd-font \
  ghostty goland keepassxc netnewswire pearcleaner podman-desktop pycharm raspberry-pi-imager signal \
  spotify visual-studio-code vlc wireshark-app
